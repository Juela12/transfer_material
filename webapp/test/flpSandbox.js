		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#TransferMaterialtransfermaterial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TransferMaterialtransfermaterial-display": {
								"semanticObject": "TransferMaterialtransfermaterial",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=TransferMaterial.transfermaterial",
									"url": sap.ui.require.toUrl("TransferMaterial/transfermaterial")
								}
							}
						}
					}
